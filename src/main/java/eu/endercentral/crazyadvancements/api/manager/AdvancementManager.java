package eu.endercentral.crazyadvancements.api.manager;
...
public interface AdvancementManager {
	 ...
	 * @param advancements An array of all advancements that should be added<br>If you want to update the display of an advancement, the array must have a length of 1
	 */
	void addAdvancement(CrazyAdvancement... advancements);

	/**
	 * Removes an advancement from the manager
	 * @param advancements An array of advancements that should be removed
	 */
	void removeAdvancement(CrazyAdvancement... advancements);
	 ...
	 */
	void updateProgress(Player player, CrazyAdvancement... advancementsUpdated);
	 ...
	 */
	void updateAllPossiblyAffectedVisibilities(Player player, CrazyAdvancement from);
	 ...
	 */
	void displayMessage(Player player, CrazyAdvancement advancement);
	 ...
	 */
	void setAnnounceAdvancementMessages(boolean announceAdvancementMessages);
	 ...
	 */
	void grantAdvancement(Player player, CrazyAdvancement advancement);
	 ...
	 * @param advancement Advancement to grant
	 */
	void grantAdvancement(UUID uuid, CrazyAdvancement advancement);
	 ...
	 */
	void revokeAdvancement(Player player, CrazyAdvancement advancement);
	 ...
	 * @param advancement Advancement to revoke
	 */
	void revokeAdvancement(UUID uuid, CrazyAdvancement advancement);
	 ...
	 */
	void grantCriteria(Player player, CrazyAdvancement advancement, String... criteria);
	 ...
	 * @param criteria
	 */
	void grantCriteria(UUID uuid, CrazyAdvancement advancement, String... criteria);
	 ...
	 */
	void revokeCriteria(Player player, CrazyAdvancement advancement, String... criteria);
	 ...
	 * @param criteria Array of criteria to revoke
	 */
	void revokeCriteria(UUID uuid, CrazyAdvancement advancement, String... criteria);
	 ...
	 * @param progress
	 */
	void setCriteriaProgress(Player player, CrazyAdvancement advancement, int progress);
	 ...
	 * @param progress
	 */
	void setCriteriaProgress(UUID uuid, CrazyAdvancement advancement, int progress);
	 ...
	 */
	int getCriteriaProgress(Player player, CrazyAdvancement advancement);
	 ...
	 * @return The criteria progress
	 */
	int getCriteriaProgress(UUID uuid, CrazyAdvancement advancement);
	 ...
	 */
	void loadProgress(Player player, CrazyAdvancement... advancementsLoaded);
	 ...
	 */
	void loadCustomProgress(Player player, String json, CrazyAdvancement... advancementsLoaded);
	 ...
	 */
	@Deprecated
	void loadProgress(UUID uuid, CrazyAdvancement... advancementsLoaded);
	 ...
	 */
	@Deprecated
	void loadCustomProgress(UUID uuid, String json, CrazyAdvancement... advancementsLoaded);
	 ...
	 */
	void unloadProgress(UUID uuid, CrazyAdvancement... advancements);
}
