...
import eu.endercentral.crazyadvancements.api.events.AdvancementGrantEvent;
import eu.endercentral.crazyadvancements.api.events.AdvancementRevokeEvent;
import eu.endercentral.crazyadvancements.api.events.CriteriaGrantEvent;
import eu.endercentral.crazyadvancements.api.events.CriteriaProgressChangeEvent;
import eu.endercentral.crazyadvancements.api.events.offline.OfflineAdvancementGrantEvent;
import eu.endercentral.crazyadvancements.api.events.offline.OfflineAdvancementRevokeEvent;
import eu.endercentral.crazyadvancements.api.events.offline.OfflineCriteriaGrantEvent;
import eu.endercentral.crazyadvancements.api.events.offline.OfflineCriteriaProgressChangeEvent;
import eu.endercentral.crazyadvancements.api.exception.UnloadProgressFailedException;
